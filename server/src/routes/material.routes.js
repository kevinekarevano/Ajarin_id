...
import { createMaterial, getCourseMaterials, getMaterial, updateMaterial, deleteMaterial, reorderMaterials, getMyMaterials, viewMaterial, servePDF } from "../controllers/material.controller.js";
import authMiddleware from "../middlewares/auth.middleware.js";
import { upload } from "../middlewares/multer.middleware.js";

const router = express.Router();

// Public routes for basic material info (enrollment required for full access)
